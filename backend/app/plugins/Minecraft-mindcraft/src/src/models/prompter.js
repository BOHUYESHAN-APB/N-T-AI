...
export class Prompter {
    constructor(agent, profile) {
        ...
        if (embedding_model_profile) {
            ...
            // 优先使用 main-brain 作为默认 embedding 代理，确保接入系统的 RAG
    ...
    async initExamples() {
        try {
            console.log('Initializing examples and skill library...');
            this.convo_examples = new Examples(this.embedding_model, settings.num_examples);
            this.coding_examples = new Examples(this.embedding_model, settings.num_examples);
            
            console.log('Loading conversation examples...');
            await this.convo_examples.load(this.profile.conversation_examples);
            console.log('Loading coding examples...');
