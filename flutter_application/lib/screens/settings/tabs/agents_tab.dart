...
class _AgentsTabState extends State<AgentsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const Text('自定义 Agent 列表', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        
        if (agents.isEmpty)
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 20),
            child: Center(child: Text('暂无自定义 Agent', style: TextStyle(color: Colors.grey))),
          ),
  ...
  Widget _buildSpecialAgentsSection(SettingsController ctrl, List<AiProviderConfig> providers) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('能力分流 (Capabilities)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
            ...
            ListTile(
              ...
              subtitle: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('当前: ${getProviderName(ctrl.settings.activeVisionProviderId)}'),
            ...
            ListTile(
              ...
              subtitle: Text('当前: ${getProviderName(ctrl.settings.activeExpressionProviderId)}'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () => _showProviderSelector(
                context, 
                ctrl, 
            ...
            ListTile(
              ...
              subtitle: Text('当前: ${getProviderName(ctrl.settings.activeSearchProviderId)}'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () => _showProviderSelector(
                context, 
                ctrl, 
